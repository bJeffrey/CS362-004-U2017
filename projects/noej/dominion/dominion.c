...
int smithyRefactored(int i, int currentPlayer, struct gameState *state, int handPos){
      /***************
      Jeffrey Noe edit
...
int council_roomRefactored(int i, int currentPlayer, struct gameState *state, int handPos){
            ...
            for (i = 0; i < 4; i++)
      	{
            ...
            /***************
            Jeffrey Noe edit
            changed for (i = 0; i < state->numPlayers; i++) to for (i = 1; i < state->numPlayers; i++)
            ***************/
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      return adventurerRefactored(drawntreasure, state, currentPlayer, cardDrawn, temphand, z);
    case council_room:
      return council_roomRefactored(i, currentPlayer, state, handPos);
    ...
    case mine:
      return mineRefactored(i, j, state, choice1, choice2, currentPlayer, handPos);
    ...
    case smithy:
      //+3 Cards
      return smithyRefactored(i, currentPlayer, state, handPos);

    case village:
      //+1 Card
      return villageRefactored(currentPlayer, state, handPos);
      drawCard(currentPlayer, state);
