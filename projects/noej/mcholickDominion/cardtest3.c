...
int main(int argc, char** argv) {
	...
	int actions = G.numActions; //player will get 2 actions

	printf("---Start Village card Test---\n");
	returner = cardEffect(village, 0, 0, 0, &G, 0, NULL);
...
int council_roomRefactoredTest(){
	...
	int result = Council_room(&state, 1);
